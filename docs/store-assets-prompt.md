...
Regenerate repository-managed screenshots with scripts/generate_store_screenshots.py. The screenshots must be captured from real MonkeySSH Flutter screens running on simulators/emulators with seeded release-demo data, not drawn as synthetic mockups. Favor terminal, tmux, Claude Code, Copilot, snippets, and agent-workspace flows; do not use subscription or checkout screens as store screenshots. Claude Code and Copilot content must use streamer-mode-safe seed data that hides emails, usernames, and private identifiers. Keep iPhone and iPad screenshots under ios/fastlane/screenshots/en-US. Keep Android phone, 7-inch tablet, and 10-inch tablet screenshots under android/fastlane/metadata-*/android/en-US/images/{phoneScreenshots,sevenInchScreenshots,tenInchScreenshots}. Make sure Fastlane continues to upload metadata, images, and screenshots from the repository.
