...
final Map<AgentLaunchTool, String> _svgByTool = <AgentLaunchTool, String>{
  ...
  AgentLaunchTool.pi: _buildSvg('0 0 24 24', const [
    _SvgPathSpec(
      'M2.75 4.5h18.5v3.1h-4.06v9.65a1.55 1.55 0 0 0 3.1 0V16h1.4v1.25a2.95 2.95 0 0 1-5.9 0V7.6h-4.2v11.9H9.4V7.6H6.3c-.13 4.4-.72 8.1-2.5 11.9H2.2c1.72-3.8 2.28-7.5 2.4-11.9H2.75z',
    ),
  ]),
  // Hermes' favicon is the winged-staff symbol, drawn here as vector paths
  // because a text glyph does not render reliably through flutter_svg.
  AgentLaunchTool.hermes: _buildSvg('0 0 24 24', const [
    _SvgPathSpec('M12 2.4a1.6 1.6 0 1 1 0 3.2 1.6 1.6 0 0 1 0-3.2z'),
    _SvgPathSpec('M11.1 6h1.8v15a.9.9 0 0 1-1.8 0z'),
    _SvgPathSpec('M11 7.2c-2.2 0-5.4.6-7 2.4 1.9.5 4.6.6 7 .1z'),
    _SvgPathSpec('M13 7.2c2.2 0 5.4.6 7 2.4-1.9.5-4.6.6-7 .1z'),
    _SvgPathSpec('M11 10.4c-1.9 0-4.4.5-5.8 2 1.6.4 3.9.5 5.8.1z'),
    _SvgPathSpec('M13 10.4c1.9 0 4.4.5 5.8 2-1.6.4-3.9.5-5.8.1z'),
  ]),
  ...
  AgentLaunchTool.openclaw:
      ...
      '<rect width="18" height="18" fill="#000" mask="url(#critter)"/></svg>',
  ...
  AgentLaunchTool.geminiCli: _buildSvg('0 0 24 24', const [
    _SvgPathSpec(
