...
class PickedSyncVaultDocument {
  ...
  const PickedSyncVaultDocument({required this.contents, required this.path});
...
class SavedSyncVaultDocument {
  ...
  const SavedSyncVaultDocument({required this.path});
...
class SyncVaultDocumentService {
  ...
  Future<SavedSyncVaultDocument?> createLinkedVault({
    ...
    return SavedSyncVaultDocument(path: _requiredString(result, 'path'));
  }
