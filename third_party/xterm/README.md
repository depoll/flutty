...
> **Vendored fork.** This is a vendored copy of [`xterm`](https://pub.dev/packages/xterm)
> **4.0.0** (`TerminalStudio/xterm.dart`), which has been unmaintained since
> February 2024. MonkeySSH vendors it here so the terminal emulation core can be
> patched directly. Changes on top of the upstream 4.0.0 baseline — primarily
> emulation-core fixes ported from [xterm.js](https://github.com/xtermjs/xterm.js)
> — are recorded in [`CHANGELOG.md`](CHANGELOG.md) under the `vendored` entries.
